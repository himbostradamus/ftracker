...
export const EXERCISES = {
  ...
  Pull: ["Seated Row", "Lat Pulldown", "Deadlift", "Pull Up", "Bicep Curl", "Reverse Pec Fly", "Back Extension"],
...
export const STOCK_DEFAULTS: Record<string, ExerciseConfig> = {
  ...
  "Back Extension": { sets: DEFAULT_EXERCISE_SETS, reps: DEFAULT_EXERCISE_REPS, w: 0, inc: 5, bw: true, rest: 60 },
...
// here so adding a new wellness activity is one entry.
